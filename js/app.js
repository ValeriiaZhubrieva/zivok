(() => {
    ...
    const discountYear = 2023;
    const discountMonth = 9;
    const discountDay = 3;
    const discountHour = 12;
    const discountMinute = 0;
    function updateTimer() {
        const now = new Date;
        const discountDate = new Date(discountYear, discountMonth - 1, discountDay, discountHour, discountMinute, 0);
